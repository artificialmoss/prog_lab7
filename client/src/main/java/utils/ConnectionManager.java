...
public class ConnectionManager {
     ...
     */
    public String handleRequest(CommandRequest request, boolean scriptMode) {
        try {
            ...
            return "Error — can't connect to the server. Try again or close the application.";
     ...
     * @return Response
     */
    private ResponseDTO getResponse() throws IOException {
        try {
