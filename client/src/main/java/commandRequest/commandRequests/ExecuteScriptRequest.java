...
public class ExecuteScriptRequest extends CommandRequest implements Runnable {
    private File file;
    private final ChangeScriptModeRequest changeScriptModeRequest;
    private final RequestManager requestManager;
    private final ResponseManager responseManager;

    public ExecuteScriptRequest(RequestManager requestManager, ResponseManager responseManager,
                                CommandRequestDTO requestDTO) {
        super("execute", requestDTO);
        this.requestManager = requestManager;
        this.responseManager = responseManager;
        this.changeScriptModeRequest = new ChangeScriptModeRequest(requestDTO);
    }
    ...
    public void run() {
        ...
        try {
            ...
            if (requestManager.getScriptHistorySize() == 1) {
                requestManager.handleRequest(changeScriptModeRequest.setScriptMode(true));
            }
            ...
            requestManager.handleRequest(changeScriptModeRequest.setScriptMode(false));
